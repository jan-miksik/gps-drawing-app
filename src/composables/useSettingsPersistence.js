...
var SETTINGS_FILE_NAME = 'app_settings.json';
export function useSettingsPersistence() {
    var _this = this;
    var saveSettings = function (settings) { return __awaiter(_this, void 0, void 0, function () {
        var error_1;
    ...
    var loadSettings = function () { return __awaiter(_this, void 0, void 0, function () {
        var result, dataString, loadedSettings, defaultSettings, validatedSettings, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                ...
                case 1:
                    ...
                    loadedSettings = JSON.parse(dataString);
                    defaultSettings = {
                    ...
                    validatedSettings = __assign(__assign({}, defaultSettings), loadedSettings);
                    return [2 /*return*/, validatedSettings];
                case 2:
                    error_2 = _a.sent();
                    console.warn('No saved settings found, using defaults:', error_2);
                    return [2 /*return*/, null];
                case 3: return [2 /*return*/];
            }
        });
    }); };
    var resetSettings = function () { return __awaiter(_this, void 0, void 0, function () {
        var error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    error_3 = _a.sent();
                    console.warn('No settings file to delete or delete failed:', error_3);
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
